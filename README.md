...
|----------|---------|---------|
| `GET /health` | API (`:4000`), worker (`:8080`) | Liveness check |
| `GET /ready`  | API (`:4000`), worker (`:8080`) | Readiness check (includes dependencies, e.g. DB) |
| `GET /api/_health` | App (`:3000`) | Liveness check |
